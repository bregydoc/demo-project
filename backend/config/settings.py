...
load_env_path = Path(__file__).resolve().parent.parent / ".env"
...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-dev-key-change-in-production-xyza1b2c3d4e5f6g7h8i9j0",
)
...
# Database
# Use /app/data for Railway persistent storage, fallback to BASE_DIR for local dev
DATABASE_DIR = Path(os.getenv("DATABASE_DIR", str(BASE_DIR)))
