...
urlpatterns = [
    ...
    # Also include all notes.urls at root to catch /notes/ and /categories/ requests
    # This ensures compatibility regardless of whether the frontend uses /api prefix or not
